...
public class Normalization{
    ...
    public static double[][] distance(double[][] data){
        Map<Double, SparseRealVector> mapData = new HashMap<Double, SparseRealVector>();
        ...
        double min = mapData.get(0).getL1Distance(mapData.get(1));
        double max = mapData.get(0).getL1Distance(mapData.get(1));
